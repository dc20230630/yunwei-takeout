<template>
  <div class="space-y-6">
    ...
    <!-- 新增员工对话框 -->
    <el-dialog v-model="dialogVisible" title="新增员工" width="500px" destroy-on-close>
...
import { addEmployee, getEmployeeList, type EmployeeListItem } from '@/api/employee'
...
const handleDelete = (id: number) => {
  ElMessageBox.confirm('确认要删除该员工账号吗？此操作将立即注销其登录权限。', '提示', {
